        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              ...
              <img class="pt-5" src="<?= base_url('assets/img/Kabupaten-Tasikmalaya.PNG')?>" height="200">
              </div>
                <div class="pl-5 pr-5 pt-3">
                  <div class="text-center">
                    <h5 class="text-gray-900 mb-4"><b>Sistem Informasi Kependudukan <br> Desa Sirnaraja <br> Kabupaten Tasikmalaya</b></h5>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Visi Misi Desa Sirnaraja</h5>
      ...
      <div class="card shadow">
                            ...
                            <h6 class="m-0 font-weight-bold text-primary text-center">Visi Desa Sirnaraja</h6>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="card shadow">
                        <div class="card-header">
                        <p class="m-0 font-weight-bold text-center text-primary">Misi Desa Sirnaraja</p>
                        </div>
