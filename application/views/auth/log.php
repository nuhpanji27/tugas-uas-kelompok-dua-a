    ...
    <div class="col-xl-10 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
            <div class="card-body p-0">
                ...
                <div class="row">
                    <div class="col-lg-6 d-none d-lg-block" style=" background : url('assets/img/bg4.PNG')">
                        <!-- Basic Card Example -->
                    ...
                    <img class="pt-5" src="<?= base_url('assets/img/ende.PNG')?>" height="200">
                        ...
                        <div class="p-5">
                            ...
                            <h5 class="text-gray-900 mb-4"><b>Sistem Informasi Kependudukan <br> Desa Sirnaraja Kab.Ende</b></h5>
                            </div>
